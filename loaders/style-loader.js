...
/* 
  ...
  4. 因为我们在style-loader的require语句中处理成为了行内loader，拼接了之前没有处理的loader内容，(注意同时通过"！！"行内loader仅使用inline-loader的语法)，
      webpack会直接调用匹配的行内loader处理后交给webpack编译，
      也就是style-loader pitch阶段返回的脚本中的require语句会被webpack执行(这也就解决了之前需要在normal阶段处理js脚本的难题)，
      得到css-loader的module.exports的值(在style-loader pitch中的require语句中)。
